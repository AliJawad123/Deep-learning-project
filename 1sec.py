...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 16 16:22:21 2022
...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 16 08:38:14 2022
...
path='//home//jawad//to_jawad//to_predict'
...
'''
    if(b1!=None):
        if(first_time_run==0 and to_check_if_b1_ran==1):
            start=time.time()
            first_time_run+=1
        end=time.time()
        if(to_check_if_b1_ran==1):
            if(end-start>3):
                b1.invoke()
                print(end-start)
                start=time.time()
